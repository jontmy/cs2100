...
\pagestyle{fancy}
\fancyhf{}
\lhead{CS2100 --- Computer Organization}
\rhead{Page \thepage}
...
\begin{document}
    ...
    \begin{multicols*}{2}
        % weight of sign bit is - 2 to the power of n - 1 (for 2s)
        % - 2 to the power of n - 1 - 1 (for 1s)
        % signs different no need to worry about overflow
        % excess-n -> n = 2^n - 1
